...
DLL=ImpactfulSkills/bin/Release/net48/ImpactfulSkills.dll
PLUGINS=ImpactfulSkills/Package/plugins
README=README.md
...
ZIPDESTINATION="../bin/Release/ImpactfulSkills.$VERSION.zip"
